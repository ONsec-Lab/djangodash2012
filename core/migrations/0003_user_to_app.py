...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Inst.ouruser'
        db.add_column('core_inst', 'ouruser',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.OurUser'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Inst.ouruser'
        db.delete_column('core_inst', 'ouruser_id')
